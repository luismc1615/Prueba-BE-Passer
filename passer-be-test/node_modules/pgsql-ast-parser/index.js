...
const grammar = {
    ...
    ParserRules: [
        ...
        { "name": "data_type_date", "symbols": ["data_type_date$subexpression$1", "data_type_date$subexpression$2", "data_type_date$subexpression$3", "data_type_date$subexpression$4"], "postprocess": x => lexer_2.track(x, { name: toStr(x, ' ') }) },
        ...
        { "name": "data_type_date", "symbols": ["data_type_date$subexpression$5", "data_type_date$subexpression$6", "data_type_date$subexpression$7", "data_type_date$subexpression$8", "data_type_date$subexpression$9"], "postprocess": x => lexer_2.track(x, { name: `timestamp ${toStr(x[2])} time zone`, config: [lexer_2.unbox(x[1])] }) },
        ...
        { "name": "qualified_name", "symbols": ["qname_ident"], "postprocess": x => lexer_2.track(x, { name: toStr(x) }) },
        { "name": "qualified_name", "symbols": ["ident", "dot", "ident_extended"], "postprocess": x => {
                const schema = toStr(x[0]);
                const name = toStr(x[2]);
                return lexer_2.track(x, { schema, name });
            } },
        ...
        { "name": "select_offset", "symbols": [(lexer_1.lexerAny.has("kw_offset") ? { type: "kw_offset" } : kw_offset), "expr_nostar", "select_offset$ebnf$1"], "postprocess": x => lexer_2.track(x, { offset: unwrap(x[1]) }) },
        { "name": "select_limit$subexpression$1", "symbols": ["select_limit_1"] },
        { "name": "select_limit$subexpression$1", "symbols": ["select_limit_2"] },
        { "name": "select_limit", "symbols": ["select_limit$subexpression$1"], "postprocess": x => lexer_2.track(x, { limit: unwrap(x) }) },
        ...
        { "name": "select_for$subexpression$1", "symbols": ["kw_update"], "postprocess": x => lexer_2.track(x, { type: 'update' }) },
        { "name": "select_for$subexpression$1", "symbols": ["kw_no", "kw_key", "kw_update"], "postprocess": x => lexer_2.track(x, { type: 'no key update' }) },
        { "name": "select_for$subexpression$1", "symbols": ["kw_share"], "postprocess": x => lexer_2.track(x, { type: 'share' }) },
        { "name": "select_for$subexpression$1", "symbols": ["kw_key", "kw_share"], "postprocess": x => lexer_2.track(x, { type: 'key share' }) },
        ...
        { "name": "select_order_by_expr", "symbols": ["expr", "select_order_by_expr$ebnf$1", "select_order_by_expr$ebnf$2"], "postprocess": x => lexer_2.track(x, {
                by: x[0],
        ...
        { "name": "expr_various_constructs$macrocall$2$macrocall$1", "symbols": ["expr_various_constructs$macrocall$2$macrocall$2"], "postprocess": x => lexer_2.track(x, {
                op: (toStr(x, ' ') || '<error>').toUpperCase()
            }) },
        ...
        { "name": "expr_various_constructs$macrocall$1", "symbols": ["expr_various_constructs$macrocall$1$subexpression$1", "expr_various_constructs$macrocall$2", "expr_various_constructs$macrocall$1$subexpression$2"], "postprocess": x => lexer_2.track(x, {
                type: 'binary',
                left: unwrap(x[0]),
                right: unwrap(x[2]),
                ...unwrap(x[1]),
        ...
        { "name": "createindex_with_item", "symbols": ["ident", (lexer_1.lexerAny.has("op_eq") ? { type: "op_eq" } : op_eq), "createindex_with_item$subexpression$1"], "postprocess": x => lexer_2.track(x, { parameter: toStr(x[0]), value: unwrap(x[2]).toString() }) },
        ...
        { "name": "comment_what_col", "symbols": ["kw_column", "qcolumn"], "postprocess": x => lexer_2.track(x, {
                type: 'column',
                column: last(x),
            }) },
        ...
        { "name": "update_set_one", "symbols": ["ident", (lexer_1.lexerAny.has("op_eq") ? { type: "op_eq" } : op_eq), "expr"], "postprocess": x => lexer_2.box(x, {
                column: asName(x[0]),
                value: unwrap(x[2]),
            }) },
        ...
        { "name": "altertable_statement", "symbols": ["kw_alter", (lexer_1.lexerAny.has("kw_table") ? { type: "kw_table" } : kw_table), "altertable_statement$ebnf$1", "altertable_statement$ebnf$2", "table_ref", "altertable_actions"], "postprocess": x => lexer_2.track(x, {
                type: 'alter table',
                ...x[2] ? { ifExists: true } : {},
                ...x[3] ? { only: true } : {},
                table: unwrap(x[4]),
                changes: lexer_2.unbox(x[5]).map(unwrap),
            }) },
        ...
        { "name": "altertable_drop_constraint", "symbols": ["kw_drop", (lexer_1.lexerAny.has("kw_constraint") ? { type: "kw_constraint" } : kw_constraint), "altertable_drop_constraint$ebnf$1", "ident", "altertable_drop_constraint$ebnf$2"], "postprocess": x => lexer_2.track(x, {
        ...
        { "name": "createtype_composite", "symbols": [(lexer_1.lexerAny.has("kw_as") ? { type: "kw_as" } : kw_as), "lparen", "createtype_composite$macrocall$1", "rparen"], "postprocess": x => lexer_2.track(x, {
        ...
        { "name": "func_argdef", "symbols": ["func_argdef$ebnf$1", "data_type", "func_argdef$ebnf$2"], "postprocess": x => lexer_2.track(x, {
                default: x[2],
                type: x[1],
                ...x[0],
            }) },
        ...
        { "name": "func_spec", "symbols": ["func_spec$ebnf$1", "func_spec$subexpression$2"], "postprocess": x => lexer_2.track(x, { leakproof: !x[0] }) },
        { "name": "func_spec", "symbols": ["func_returns"], "postprocess": x => lexer_2.track(x, { returns: unwrap(x) }) },
        ...
        { "name": "drop_func", "symbols": ["kw_drop", "kw_function", "drop_func$ebnf$1", "qname", "drop_func$ebnf$2"], "postprocess": x => lexer_2.track(x, {
                type: 'drop function',
                ...x[2] && { ifExists: true },
                name: x[3],
                ...x[4] && { arguments: x[4] },
        ...
        { "name": "drop_func_overload_col", "symbols": ["drop_func_overload_col$ebnf$1", "qname"], "postprocess": x => lexer_2.track(x, {
                type: x[1],
                ...x[0] && { name: asName(x[0]) },
            }) },
...
const visitor = ast_visitor_1.astVisitor(m => ({
    ...
    createIndex: c => {
        ...
        if (c.with) {
            ret.push('WITH ');
            list(c.with, w => {
                ret.push(w.parameter, ' = ', pg_escape_1.literal(w.value));
            }, true);
        }
        if (c.tablespace) {
