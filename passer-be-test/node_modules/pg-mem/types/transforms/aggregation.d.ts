...
export declare function buildGroupBy(on: _ISelection, groupBy: Expr[], select: SelectedColumn[]): _ISelection<any>;
export declare function getAggregator(): Aggregation<unknown> | null;
